...
<div class="news_main">
    ...
    <div class="l_left news_right">
        ...
        <div class="notice_check">
            <div class="btn-group l_left" style="margin-right: 4px;width:120px;">
                <button type="button" class="btn btn-default change" style="height: 30px;line-height: 30px;padding: 0 12px !important;font-size: 12px;width:60%;">选择条件</button>
